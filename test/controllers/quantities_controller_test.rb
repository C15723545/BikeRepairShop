...
class QuantitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post quantities_url, params: { quantity: { part_id: @quantity.part_id, quantity: @quantity.quantity, repair_id: @quantity.repair_id } }
    end
  ...
  test "should update quantity" do
    patch quantity_url(@quantity), params: { quantity: { part_id: @quantity.part_id, quantity: @quantity.quantity, repair_id: @quantity.repair_id } }
